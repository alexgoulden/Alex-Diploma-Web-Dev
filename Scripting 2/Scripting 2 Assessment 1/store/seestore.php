<?php
//connect to database
$mysqli = mysqli_connect("localhost", "root", "", "php-store") or die("Could not connect database...");

$display_block = "<h1>My Catgeories</h1>
...
?>
    ...
    <html lang="en">
        ...
        <body>
            <h3>Check out our community forum <a href="forum/categorylist.php">here!</a></h3>
            <?php echo $display_block; ?>
            <div id="ajax-functionality">
            <h1>This store template proudly brought to you by...</h1>
            <button type="button" onclick="loadDoc()">wait for it...</button>
            </div>
            ...
            function loadDoc() {
              ...
              xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                  document.getElementById("ajax-functionality").innerHTML =
                  this.responseText;
                }
              };
